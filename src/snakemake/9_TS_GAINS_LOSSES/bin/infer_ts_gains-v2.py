...
OG_to_classify = [OG_ID for OG_ID in OG_to_classify if OG_ID not in no_TS_OGs and OG_ID not in single_TS_OG_deut]
print(len(OG_to_classify))
...
OG_to_classify = [element for element in OG_to_classify if element not in first_node_OGs]
...
OG_to_classify = [OG_ID for OG_ID in OG_to_classify if OG_ID not in no_TS_OGs and OG_ID not in single_TS_OG_prot]
