...
for (species in c("Mm2", "Dme")) {
  ...
  all_protein_coding_taus_df$Category = rep("Post-bilaterian", nrow(all_protein_coding_taus_df))
  ...
  if (species=="Mm2") {
    ...
    scale_color_manual(values=c("Bilaterian conserved"="brown3", "Post-bilaterian"="dimgray")) +
    scale_fill_manual(values=c("Bilaterian conserved"="brown3", "Post-bilaterian"="dimgray")) +
...
# pdf("/Users/federica/Documents/CRG_PhD/bilaterian_GE/Images/Images_from_R/Fig4_extra.pdf", width=6.5, height = 3)
# print(combined_extra_plots)
# dev.off()
```
