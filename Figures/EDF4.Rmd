...
```{r plot_genes_connected_by_lines, echo=FALSE, warning=FALSE, message=FALSE, dependson=c("setup", "functions"), fig.width=5, fig.height=4}
...
for (query_tissue in ordered_tissues) {
  ...
  if (query_tissue == "Adipose") {
    ...
    my_loadings_vertebrate_file = paste0(splsda_dir, my_version, "/", my_category, "/Bilateria/", my_evo_type, 
                                         "/loadings_clade_tissue/metasamples_median_expr/", query_tissue, "/splsda_zscore_comb/Vertebrata_",
  ...
  my_loadings_insects_file = paste0(splsda_dir, my_version, "/", my_category, "/Bilateria/", my_evo_type, 
                                     "/loadings_clade_tissue/metasamples_median_expr/", query_tissue, "/splsda_zscore_comb/Insecta_",
                            query_tissue, "_splsda-zscore_loadings_orthogroups-GO_input.txt")
...
panel_K = plot_grid(plotlist = all_dot_plots, ncol=2)
print(panel_K)

panel_K = egg::ggarrange(all_dot_plots[[1]], 
                         all_dot_plots[[2]] +
